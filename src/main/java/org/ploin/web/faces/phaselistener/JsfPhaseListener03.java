 ...
 */
public class JsfPhaseListener03 implements PhaseListener {

	
	private static final long serialVersionUID = -2014346712801091271L;
	private Log log = LogFactory.getLog(JsfPhaseListener03.class);
	...
	public void beforePhase(PhaseEvent arg0) {
		...
		session.setAttribute(JSF_PHASE, 3);
	}
