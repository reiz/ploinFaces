 ...
 */
public class JsfPhaseListener05 implements PhaseListener {


	private static final long serialVersionUID = -9167119934252783050L;
	private Log log = LogFactory.getLog(JsfPhaseListener05.class);
	...
	public void beforePhase(PhaseEvent event) {
		...
		session.setAttribute(JSF_PHASE, 5);
	}
